...
const OrderSuccess = () => {
    return (
        <div className='flex flex-col items-center justify-center min-h-[80vh] px-6 text-center bg-linear-to-b from-green-200 to-white'>
            <motion.div
            ...
            <motion.p
                ...
                className='text-gray-600 mt-3 text-sm md:text-base max-w-d'
            >
            ...
            >
                ...
                <div className='absolute top-32 left-[30%] w-2 h-2 bg-green-400 rounded-full animate-pulse'></div>
