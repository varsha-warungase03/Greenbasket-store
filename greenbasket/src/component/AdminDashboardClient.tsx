  ...
  return (
    <div className='pt-28 w-[90%] md:w-[80%] mx-auto'>
        <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-10 text-center sm:text-left'>
            ...
            <select  className='border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-green-500 outline-none transition w-full sm:w-auto' value={filter}  onChange={(e) => setFilter(e.target.value  as any)} >
