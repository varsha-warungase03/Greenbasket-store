'use client'
import { Apple, Baby, Box, ChevronLeft, ChevronRight, Coffee, Cookie, Flame, Heart, Home, Icon, Milk, Wheat } from 'lucide-react'
...
const Categoryslider = () => {
    const categories=[
        ...
        {id:8,name:"Houshold Essentials",icon:Home,color:"bg-lime-100"},
        {id:9,name:"Instant & Packaged Foode",icon:Box,color:"bg-teal-100"},
