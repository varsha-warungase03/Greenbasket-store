...
const GroceryitemCard = ({item}:{item:IGrocery}) => {
  ...
  return (
    ...
    >
        <div className='relative w-full aspect-4/3  overflow-hidden group bg-gray-50'>
            <Image src={item.image} fill alt={item.name} className='max-w-3xl object-contain p-4 transition-transform duration-500 grop-hover:scale-105'/>
